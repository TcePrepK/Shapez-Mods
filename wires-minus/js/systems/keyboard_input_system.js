...
import { getStringForKeyCode, Keybinding } from "shapez/game/key_action_mapper";
...
export class KeyboardInputSystem extends GameSystemWithFilter {
    constructor(root) {
        super(root, [KeyboardInputComponent]);
    ...
    gameRestored() {
        ...
        for (const entity of this.allEntities) {
            ...
            const keyboardInput = entity.components["KeyboardInput"];

            const code = keyboardInput.assignedKeyCode;
    ...
    channelSignalValue(entity) {
        ...
        dialog.inputReciever.keydown.add(({ keyCode, shift, alt, event }) => {
            ...
            keyboardInput.assignKey(key, keyCode);
    ...
    drawChunk(parameters, chunk) {
        ...
        for (let i = 0; i < contents.length; ++i) {
            ...
            const keyText = keyboardInput.assignedKey;
            ...
            if (!keyboardInput.pressing) {
                ...
                // ctx.strokeStyle = "#686a72";
                // ctx.fillStyle = "#89dd5c";
                // this.drawStroked(ctx, keyText, origin.x, origin.y - offset);
            }
        }
    }
